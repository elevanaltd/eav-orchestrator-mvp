-- Fixed Test Users Setup for Local Supabase (v2.47.2 compatible)
-- Run: psql "postgresql://postgres:postgres@127.0.0.1:54322/postgres" < supabase/create-test-users-fixed.sql
...
BEGIN
  ...
  IF admin_user_id IS NULL THEN
    INSERT INTO auth.users (
      ...
      '', '', '', ''  -- Empty strings instead of NULL for token fields
